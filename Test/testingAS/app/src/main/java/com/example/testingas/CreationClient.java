...
public class CreationClient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectCrCl=findViewById(R.id.connexionClient);
        username=findViewById(R.id.courrielclient);
        password=findViewById(R.id.passwordclient);
        DB = new dbHelper(this);
        prenom=findViewById(R.id.prenomclient);
        nom=findViewById(R.id.nomclient);
        adresse=findViewById(R.id.adresseclient);
